...
inline ImagePtr ch01::fig_1_12::applyGamma(ImagePtr image_ptr, double gamma) {
...
inline ImagePtr ch01::fig_1_12::applyTint(ImagePtr image_ptr, const double* tints) {
    auto output_image_ptr =
...
inline void ch01::fig_1_12::fig_1_12_run(std::vector<ImagePtr>& image_vector) {
...
inline void ch01::fig_1_12::writeImage(ImagePtr image_ptr) {
    image_ptr->write((image_ptr->name() + ".bmp").c_str());
}

inline int ch01::fig_1_12::main() {
