...
using namespace ch01;
 void ch01::fig_1_07::fig_1_07_run(const std::vector<ImagePtr>& image_vector) {
 ...
 ImagePtr ch01::fig_1_07::applyGamma(ImagePtr image_ptr, double gamma) {
 ...
 ImagePtr ch01::fig_1_07::applyTint(ImagePtr image_ptr, const double* tints) {
    auto output_image_ptr =
 ...
 void ch01::fig_1_07::writeImage(ImagePtr image_ptr) {
    image_ptr->write((image_ptr->name() + ".bmp").c_str());
}

 int ch01::fig_1_07::main() {
