...
ImagePtr ch01::fig_1_11::applyGamma(ImagePtr image_ptr, double gamma) {
...
ImagePtr ch01::fig_1_11::applyTint(ImagePtr image_ptr, const double* tints) {
    auto output_image_ptr =
...
void ch01::fig_1_11::fig_1_11_run(std::vector<ImagePtr>& image_vector) {
...
void ch01::fig_1_11::writeImage(ImagePtr image_ptr) {
    image_ptr->write((image_ptr->name() + ".bmp").c_str());
}

int ch01::fig_1_11::main() {
